...
______________________ BASIC _____________________
1. do not show the link to them who should not see it only show to the person/types of user who should see it 
2. Do not allow to visit the link by typing on the url. I use AdminRoute that will check whether the user is admin or not if not admin then redirect to any other page. you could logout user and send them to the login page as well.

_____________________ TO SEND DATA ________________
