...
<nav className=" border-gray-200 bg-[#e1e7d1]">
  ...
  <div className={`items-center ${ShowMenu ? '': 'hidden'} justify-between w-full md:flex md:w-auto md:order-1" id="mobile-menu-2`}>
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0">
      <li>
        <NavLink to="/" className="block py-2 pl-3 pr-4 text-[#60781e] rounded md:hover:text-[#2f3816] md:p-0 " aria-current="page">Home</NavLink>
      </li>
      <li>
        <a href="#aboutSection" className="block py-2 pl-3 pr-4 text-[#60781e] rounded md:hover:text-[#2f3816] md:p-0 ">About</a>
      </li>
      <li>
        <a href='#servicesSection' className="block py-2 pl-3 pr-4 text-[#60781e] rounded  md:hover:text-[#2f3816] md:p-0 ">Services</a>
      </li>
      <li>
        <NavLink to="/blog" className="block py-2 pl-3 pr-4 text-[#60781e] rounded md:hover:text-[#2f3816] md:p-0 ">Blog</NavLink>
      </li>
    </ul>
  </div>
  </div>
